...
var allArr = _.map(arr, "skills");
var arr2 = [];
for (var i = 0; i < allArr.length; i++) {
  arr2 = _.union(arr2, allArr[i]);  
}
...
//   arr3.push(el.toLowerCase());
// });

arr2 = arr2.sort(fnSort);
console.log(arr2);
console.log('_______________');

// var task3 = [];
// arr.forEach(function (el, index) {
//  task3.push( _.pick(arr[index], ['friends', 'name']));
// })
// console.log(task3);

// task3 = _.sortBy(task3, 'friends.length');

// console.log(task3);

  
var task3 = null;
task3 = _.sortBy(arr, 'friends.length');

var task3 = _.map(task3, "name");
console.log(task3);
console.log('_______________');

var task4 = _.map(arr, "friends");
task4 = _.flatten(task4);
task4 = _.map(task4, "name");

var emptyArr = [];
task4 = _.union(emptyArr, task4);
console.log(task4);